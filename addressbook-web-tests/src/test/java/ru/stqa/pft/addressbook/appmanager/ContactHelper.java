...
public class ContactHelper extends HelperBase {
    ...
    public Contacts all() {
        ...
        for (WebElement row : rows) {
            ...
            contactCashe.add(new ContactData().withId(id).withFirstname(firstname).withLastname(lastname).withAddress(null).withHomePhone(phones[0]).withMobilePhone(phones[1]).withWorkPhone(phones[2]).withEmail(null).withGroup(null));
        }
        return new Contacts(contactCashe);
    }
