...
public class ContactHelper extends HelperBase {
    ...
    public Contacts all() {
        ...
        for (WebElement element : elements) {
            ...
            contactCashe.add(new ContactData().withId(id).withFirstname(firstname).withLastname(lastname).withAddress(null).withPhone(null).withEmail(null).withGroup(null));
        }
        return new Contacts(contactCashe);
    }
}
